...
class AuthControllerTest extends TestCase
{
     ...
     * @group API
     * @group API-1.5.0
     * @group API-1.5.0-AuthController
     * @return Void
     */
    public function testCheckNoToken()
    {
        // Do Request
        $this->_request('GET', '/api/1.5.0/check')
    ...
    public function testCheckWithInvalidPromotorToken()
    {
        ...
        // Do request
        $this->_request('GET', '/api/1.5.0/check', ['token' => '1234'])
            ->_result(['ID' => 0]);
    }
    ...
    public function testCheckWithValidPromotorTokenWithBlock()
    {
        ...
        // Do request
        $this->_request('GET', '/api/1.5.0/check', ['token' => $encryptedToken])
            ->_result(['ID' => 0]);
    }
    ...
    {
        // Do request
        $this->_request('POST', '/api/1.5.0/login', ['phone' => '1234', 'password' => '1234'])
            ->_result(['error' => 'login-error']);
    }
    ...
    public function testLoginPromotorWithHavasPasswordDifferentInput()
    {
        ...
        $this->_request('POST', '/api/1.5.0/login', $params)
            ->_result(['error' => 'login-error']);
    }
    ...
    public function testLoginPromotorWithHavasPassword()
    {
        ...
        $response   = $this->call('POST', '/api/1.5.0/login', $params);
